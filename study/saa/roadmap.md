...
- [x] Route 53 ルーティング（第6章）
- [x] DR 4戦略 / RPO・RTO（第13章の弾力性と併読）
- [x] RDS Multi-AZ / Read Replica（第5章）
- [x] S3 耐久性・レプリケーション（第4章）

### シナリオ — 100分 — 第13章（弾力性）

- [x] 第13章の弾力性・高可用の節 + 練習問題
- [x] 疎結合 / DR 選定 / SPOF 排除
...
- [x] CloudFront / Global Accelerator（第6章）

### データベース — 55分 — 第5章

- [x] RDS / Aurora / DynamoDB
- [x] ElastiCache / DAX
- [x] 読み取りスケール / パーティション
...
- [x] 第13章の高性能の節 + 練習問題
- [x] ストレージ・DB 選定 / キャッシュとエッジ（ストレージ側は第4で充足。DBは第5済）

## 4. コスト最適化アーキテクチャ（20%） — 4.0h

### ストレージコスト — 45分 — 第4章 + 第11章

- [x] S3 ストレージクラス / ライフサイクル（第4章）
- [x] EBS タイプ / スナップショット（第4章）
